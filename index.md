...
<section class="feed-hero" aria-labelledby="feed-heading">
  <header class="feed-heading">
    <div><p class="eyebrow">Movies, miles, and side quests</p><h1 id="feed-heading">Welcome to Noland.</h1></div>
    <p>A few things I'm watching, making, writing, and exploring. Pick a path.</p>
  </header>
  <nav class="home-shortcuts" aria-label="Explore Noland">
    <a class="home-shortcut home-shortcut-movies" href="{{ '/reviews/diary/' | relative_url }}">
      ...
      <p>Movie reviews, ratings, and everything I've logged.</p>
    ...
    <a class="home-shortcut home-shortcut-paddle" href="{{ '/projects/florida-keys/' | relative_url }}">
      ...
      <span class="home-shortcut-label">Paddleboarding</span>
      <h2>Around the Keys</h2>
      <p>One island at a time. Follow the routes and the miles.</p>
      <span class="home-shortcut-arrow" aria-hidden="true">&#8599;</span>
    </a>
    <a class="home-shortcut home-shortcut-crossword" href="{{ '/crossword-creator/' | relative_url }}">
      ...
      <span class="home-shortcut-label">Crossword creator</span>
      <h2>A little wordplay</h2>
      <p>Build a grid, write the clues, and try the solve.</p>
      <span class="home-shortcut-arrow" aria-hidden="true">&#8599;</span>
    </a>
    <a class="home-shortcut home-shortcut-code" href="{{ '/projects/application-event-lab/' | relative_url }}">
      ...
      <span class="home-shortcut-label">Latest coding project</span>
      <h2>Application Event Lab</h2>
      <p>Send an event. Break the flow. See how it recovers.</p>
      <span class="home-shortcut-arrow" aria-hidden="true">&#8599;</span>
    </a>
    <a class="home-shortcut home-shortcut-writing" href="{{ '/blood-manatees/' | relative_url }}">
      ...
      <span class="home-shortcut-label">Latest writing project</span>
      <h2>Blood Manatees</h2>
      <p>Step inside an interactive screenplay in progress.</p>
      <span class="home-shortcut-arrow" aria-hidden="true">&#8599;</span>
    </a>
  </nav>
</section>
